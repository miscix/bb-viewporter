    ...
    qq.FileUploader = function(o){
        ...
        qq.extend(this._options, {
            ...
            template: '<div class="qq-uploader row-fluid">' +
                (!this._options.disableDefaultDropzone ? '<div class="qq-upload-drop-area span8"><span>{dragText}</span></div>' : '') +
                (!this._options.button ? '<a class="qq-upload-button btn btn-dm span4 pull-right">{uploadButtonText}</a>' : '') +
